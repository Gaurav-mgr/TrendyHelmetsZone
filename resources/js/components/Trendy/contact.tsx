    ...
    <>
      ...
      <section className="relative w-[1600px] mt-[100px]">
        <div className="sticky top-30 h-[80vh] py-4 px-8 flex flex-col gap-13 ">
          <div className="flex flex-col items-center gap-1 mb-[70px]">
            <h1 className="text-[#ff3635] text-[70px] uppercase font-bold leading-none">Let's Connect</h1>
          </div>

          <div id="fadeup" className="max-w-[1400px] mx-auto grid grid-cols-1 grid-cols-[1fr_1.2fr] gap-24">
            {/* LEFT — spec sheet */}
            ...
            <form className="contact-form flex flex-col gap-10 self-center">
              ...
              <button
                ...
                type="submit"
                className="cursor-pointer w-[50%] bg-[#cc3635] hover:bg-[#b02e2d] text-white border-1 border-[#cc3635] font-bold py-3 px-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-[1.01] shadow-lg shadow-[#cc3635]/20 hover:bg-transparent hover:text-[#cc3635] transition-all duration-400"
              >
                Send message
              </button>
            </form>
